...
public class ZenAntiBan {
    public int ANTIBAN_RATE = 10; // This is the frequency rate for anti-ban actions (in % terms - 100% = frequent, 0% = never
            ...
            switch(event) {
                case 0: { // Examine random entity
                    if(rp < 25) { // 25% chance
                        ...
                        if(r(0, 100) < 99) { // 99% chance of clicking examine
                            ...
                            rh(1, 100);
                            menu.open();
                            MethodProvider.sleep(rh(250, 1000));
                ...
                case 3: { // Move mouse to random location (and sometimes click)
                    if(rp < 10) { // 10% chance
                        ...
                        if(r < 4) // 10% chance of right-clicking
    ...
    private void print(Object o) {
        MethodProvider.log("[AntiBan] " + o.toString());
    }
    ...
    public boolean checkPlayerMessage(Message message) {
        ...
        if(chatbot != null && !chatbot.equals("")) {
            ...
            MethodProvider.log("[ChatBot] Reply: " + chatbot + ", Phrase: " + message.getMessage() + ", From: " + message.getUsername());
            MethodProvider.sleep(rh(3000, 5000));
    ...
    public boolean containsSpam(String phrase) {
        ...
        return spam.contains("sell") || spam.contains("usd") || spam.contains("gp") || spam.contains("fee") || spam.contains("free") || spam.contains("join") || phrase.equals("") || phrase.length() <= 1;
